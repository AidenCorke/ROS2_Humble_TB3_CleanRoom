...
# Custom imports
from clean_room.planner.mapping.map_processor import MapProcessor
from clean_room.planner.planning.room_cleaning_path_planner import RoomPathPlanner
...
class CleaningManager:
    ...
    def __init__(self, rooms_config_path, map_yaml_path):
        ...
        self.room_config = data["room_name"]
